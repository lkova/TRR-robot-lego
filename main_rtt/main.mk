...
# Autogenerated on: 19-May-2017 07:47:38
# Model: MAIN
# File name: main.mk
# Template: gmake 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2014b/legomindstormsnxt/toolbox/realtime/targets/lego/include" -I"C:/Users/unixy/Desktop/ogel/gole/main_rtt" -I"C:/Users/unixy/Desktop/ogel/gole" -I"C:/Users/unixy/Desktop/gole" -I"C:/Program Files/MATLAB/R2014b/extern/include" -I"C:/Program Files/MATLAB/R2014b/simulink/include" -I"C:/Program Files/MATLAB/R2014b/rtw/c/src" -I"C:/Program Files/MATLAB/R2014b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2014b/rtw/c/ert" -I"C:/Program Files/MATLAB/R2014b/toolbox/coder/rtiostream/src/utils" -I"C:/MATLAB/SupportPackages/R2014b/legomindstormsnxt/toolbox/realtime/targets/lego/src"  -D"MODEL=main"  -D"NUMST=2"  -D"NCSTATES=0"  -D"HAVESTDIO="  -D"ON_TARGET_WAIT_FOR_START=1"  -D"ONESTEPFCN=0"  -D"EXT_MODE=1"  -D"TERMFCN=1"  -D"MAT_FILE=0"  -D"MULTI_INSTANCE_CODE=0"  -D"INTEGER_CODE=0"  -D"MT=0"  -D"CLASSIC_INTERFACE=0"  -D"ALLOCATIONFCN=0"  -D"TID01EQ=0"  -D"EXIT_FAILURE=1"  -D"EXTMODE_DISABLEPRINTF="  -D"EXTMODE_DISABLETESTING="  -D"EXTMODE_DISABLE_ARGS_PROCESSING=1" 

COMPILER_TCCFG_ARGS := -c -ffreestanding -fsigned-char -mcpu=arm7tdmi -Os -Winline -Wall -Werror-implicit-function-declaration --param max-inline-insns-single=1000 -mthumb -mthumb-interwork -ffunction-sections -fdata-sections -nostdinc -iquote"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/lejos_nxj/src/nxtvm/javavm" -iquote"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/lejos_nxj/src/nxtvm/platform/nxt" -iquote"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/ecrobot/bios" -iquote"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/ecrobot/c" -iquote"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/c++" -I. -I"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/toppers_osek/kernel" -I"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/toppers_osek/include" -I"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/toppers_osek/config/at91sam7s-gnu" -I"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/toppers_osek/config/at91sam7s-gnu/lego_nxt" -I"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/toppers_osek/syslib/at91sam7s-gnu/lego_nxt" -I"C:/MATLAB/SupportPackages/R2014b/GNU_Tools_ARM_Embedded/lib/gcc/arm-none-eabi/4.8.3/include" -I"C:/MATLAB/SupportPackages/R2014b/GNU_Tools_ARM_Embedded/lib/gcc/arm-none-eabi/4.8.3/include-fixed" -I"C:/MATLAB/SupportPackages/R2014b/GNU_Tools_ARM_Embedded/arm-none-eabi/include" -DLEGO -std=gnu99
COMPILER_ARGS := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)

LINKER_CODEGEN_ARGS := 

LINKER_TCCFG_ARGS := -nostartfiles -o $(TARGET) -T ./mine.ld -mthumb -mthumb-interwork -Wl,--allow-multiple-definition  -Wl,--gc-sections -L"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/ecrobot" -L"C:/MATLAB/SupportPackages/R2014b/nxtOSEK/c++" -Wl,--start-group -lgcc -lc -lc -lm -lnosys -Wl,--end-group -lm -llejososek -lecrobot
...
COMPILER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2014b\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-gcc)

LINKER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2014b\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-g++)

PREBUILD_TOOL ?= 

POSTBUILD_TOOL ?= $(subst \,/,C:\MATLAB\SupportPackages\R2014b\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-objcopy)
